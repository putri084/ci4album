...
<section class="content">
  <div class="box">
    <div class="box-header with-border">
      <h4 class="box-title text-capitalize">Data photos</h4>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group mb-3">
									<label for="album_id" class="col-form-label"> Album id: <span class="text-danger">*</span> </label>
									<input type="number" id="album_id" name="album_id" class="form-control" placeholder="Album id" minlength="0"  required>
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group mb-3">
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          //insert data to form
			...
			$("#data-form #album_id").val(response.album_id);
