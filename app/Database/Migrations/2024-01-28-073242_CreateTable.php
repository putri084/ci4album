...
class CreateTable extends Migration
{
    public function up()
    {
        ...
        // make migration for album table
        $this->forge->addField([
            'id' => [
                'type' => 'INT',
                'constraint' => 11,
        ...
        $this->forge->addForeignKey('user_id', 'users', 'id', 'CASCADE', 'CASCADE');
        $this->forge->createTable('comment_photos');

        // make migration for like_foto table
        $this->forge->addField([
            'id' => [
                'type' => 'INT',
                'constraint' => 11,
        ...
        $this->forge->addForeignKey('photo_id', 'photos', 'id', 'CASCADE', 'CASCADE');
        $this->forge->addForeignKey('user_id', 'users', 'id', 'CASCADE', 'CASCADE');
        $this->forge->createTable('like_photos');
    }
